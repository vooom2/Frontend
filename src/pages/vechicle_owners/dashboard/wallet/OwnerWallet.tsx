                      ...
                      {walletHistoryStore.history.length > 0 ? (
                        walletHistoryStore.history.map((withdrawal, index) => (
                          <TableRow key={index}>
                            ...
                            <TableCell>
                              <Badge
                                className={getStatusStyle(withdrawal.type)}
                              >
                                {withdrawal.type}
                              </Badge>
                            </TableCell>
                            ...
                            <TableCell>
                              {formatCurrency(withdrawal.oldBalance)}
                            </TableCell>
                            <TableCell>
                              {formatCurrency(withdrawal.newBalance)}
                            </TableCell>
                          </TableRow>
                        ))
                      ) : (
                        <TableRow>
                          <TableCell colSpan={6} className="text-center">
                            <img
                              src={emptyImg}
                              className="w-52 mt-8 mx-auto opacity-70"
                            />{" "}
                            <p className="text-gray-500 text-center mt-4 mb-4">
