              ...
              <div className="space-y-6 col-span-2">
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge
                      className={cn(
                        vehicleDetails.vehicle.active_vehicle
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                <Card className="lg:col-span-4">
                  <Table>
                    ...
                    {vehicleDetails.inspection.length > 0 ? (
                      <TableBody>
                        {vehicleDetails.inspection.map((inspection, index) => (
                          <TableRow key={index}>
                            <TableCell className="font-medium">
                              {getLocalFriendlyDate(inspection.createdAt)}
                            </TableCell>
                            <TableCell>
                              <p className="text-xs">
                            ...
                            <TableCell>
                              <p className="text-xs">
                                {getLocalFriendlyDate(inspection.due_date)}
                              </p>
                            </TableCell>
                          </TableRow>
                        ))}
              ...
              <div className="space-y-4 col-span-2 md:col-span-1">
                ...
                <div className="grid grid-cols-3 gap-2 justify-center">
                  {[...Array(3)].map((_, i) => (
                    <div
                      key={i}
                      className="relative aspect-square bg-gray-300 rounded-lg w-full"
                    ></div>
                  ))}
                </div>
              </div>
